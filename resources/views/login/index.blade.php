                            ...
                            <div class="card-body p-4 p-lg-5 text-black">
                                ...
                                <form action="/login" method="POST">
                                    ...
                                    <div class="d-flex align-items-center mb-3 pb-1">
                                        <span class="h1 fw-bold mb-0">Hotel VLOYVE</span>
                                    </div>

                                    <h5 class="fw-normal mb-3 pb-3" style="letter-spacing: 1px;">Sign into your account</h5>

                                    <div class="form-outline mb-4">
                                        <input style="border-radius: 1rem;" type="email" id="email" class="form-control form-control-lg @error('email') is-invalid @enderror" name="email"
                                    ...
                                    <div class="form-outline mb-4">
                                        <input style="border-radius: 1rem;" type="password" id="password" name="password" placeholder="Password"
