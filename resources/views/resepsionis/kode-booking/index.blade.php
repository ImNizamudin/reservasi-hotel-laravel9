...
<div style="margin-left: 30px;" class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
...
{{-- <div style="margin-left: 30px;" class="table-responsive col-lg">
    <a href="/admin/fasilitas-kamar/create" class="btn btn-primary mb-3"><span><svg xmlns="http://www.w3.org/2000/svg" 
        viewBox="0 0 24 24" width="20" height="20"><path fill="none" d="M0 0h24v24H0z"></path>
        <path fill="currentColor" d="M11 11V5h2v6h6v2h-6v6h-2v-6H5v-2z"></path></svg></span>Tambah Kode Booking</a>
